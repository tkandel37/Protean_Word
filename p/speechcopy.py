...
def audio(text):
    ...
    def speed():
        ...
        if _speed == 'True':
           ...
           speed_button.config(bg='purple') 
           speed_content_box.pack_forget()
           _speed = 'abcd'
    ...
    def volume():
        ...
        if _volume == 'True':
           ...
           volume_button.config(bg='purple') 
           volume_content_box.pack_forget()
           _volume = 'abcd'
    ...
    def gender():
        ...
        if _gender == 'True':
            ...
            gender_content_box.pack()
            _gender = 'else'
            gendernumber = int(file_read(2))

            select_gender.config (bg='black')

        else:
            gender_button.config(bg='purple')
            gender_content_box.pack_forget()
            _gender = 'abcd' 


        
    def save():
        url = filedialog.asksaveasfile( defaultextension='*.mp3', filetypes=(('Audio File', '*.mp3'),))
...
#################### Apply and Reset ##################################
   ...
   ################ END Save and Reset ##############################
    ...
    fg='white',  font=('Arial',20), command=save)
    save_button.pack()
